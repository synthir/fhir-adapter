...
public class FHIRServerEndpoint {
	...
	public ResponseEntity<Object> uploadFHIRResourcesJsonToFHIRServer(HttpServletRequest request,
	...
	@SuppressWarnings("null")
	public ResponseEntity<List<ResourceResList>> downloadFHIRResourcesJsonFromFHIRServer(HttpServletRequest request,
			@RequestParam("fhirServerUrl") String fhirServerBaseUrl) {
		...
		String fhirResourceRequestUrl = fhirServerBaseUrl + APIConstants.REQUEST_SEPARATOR
				+ APIConstants.FHIR_RESOURCE_ENCOUNTER + "?_count=1000";

		fhirResourcesListToPopulate = fhirServerEngine.downloadFHIRResourcesObjFromFHIRServer(fhirResourceRequestUrl,
